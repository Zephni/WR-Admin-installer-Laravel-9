<x-frontend-layout>
    ...
    <section class="my-12 mx-auto pb-2 px-2 py-2 bg-slate-300 shadow-lg rounded-lg font-bold w-full max-w-3xl" style="background: linear-gradient(to right,#ee7724,#d8363a,#dd3675,#b44593);">
        <table class="w-full">
            <thead class="text-left text-gray-100 uppercase">
                <tr>
                    <th class="px-2 py-1 text-xl">Key</th>
                    <th class="px-2 py-1 text-xl">Value</th>
                </tr>
            </thead>
            <tbody class="">
                ...
                @foreach ([
                    ...
                    @php
                        ...
                        if($keySection !== $keyBuffer) {
                            ...
                            echo '<tr class="bg-slate-800 text-gray-100"><td colspan="2" class="px-2 py-1 rounded-t-lg" style="border-bottom: 2px solid #c057a1;">' . $keySection . '</td></tr>';
                        }
                    @endphp
                    <tr>
