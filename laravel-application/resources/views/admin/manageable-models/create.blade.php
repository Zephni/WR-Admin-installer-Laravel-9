<x-admin-layout>
    ...
    <div class="w-full">
        <form action="{{ route('admin.manageable-models.create.submit', ['table' => $model->getTable()]) }}" method="post" class="border-b bg-gray-800 border-gray-700 rounded px-8 pt-6 pb-8 mb-4">
            @csrf
