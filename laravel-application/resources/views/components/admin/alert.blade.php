...
<div id="{{ $alertID }}" x-show="show" x-transition.duration.400ms {{ $attributes->merge(['class' => 'p-2 my-4 text-sm rounded-lg relative '.$typeClasses]) }} role="alert" x-data="{ show: true }">
