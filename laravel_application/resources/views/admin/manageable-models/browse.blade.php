<x-admin-layout>
    ...
    <h2 class="relative text-4xl font-light text-gray-300">{{ $pageTitle }}</h2>
    ...
    <div class="w-full mb-6 flex justify-between">
        ...
        <x-admin.button
            ...
            text="<i class='bi bi-file-earmark-plus text-base'></i> Create new"
            type="primary" />
    </div>
        ...
        @if(count($rows) === 0)
            <div class="w-full mt-10 flex justify-center items-center">
                <div class="text-1xl font-bold text-gray-500">
                    ...
                    <a href="{{ route('admin.manageable-models.create', ['table' => $model->getTable()]) }}" class="text-teal-500 hover:text-teal-400"><i class="bi bi-file-earmark-plus"></i> create new</a>.
                </div>
            </div>
        @else
